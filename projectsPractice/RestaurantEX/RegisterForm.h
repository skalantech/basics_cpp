...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Size = System::Drawing::Size(781, 78);
			...
			// tbName
			// 
			this->tbName->Location = System::Drawing::Point(308, 116);
			this->tbName->Name = L"tbName";
			this->tbName->Size = System::Drawing::Size(483, 38);
			this->tbName->TabIndex = 2;
			// 
			// tbEmail
			// 
			this->tbEmail->Location = System::Drawing::Point(308, 171);
			this->tbEmail->Name = L"tbEmail";
			this->tbEmail->Size = System::Drawing::Size(483, 38);
			this->tbEmail->TabIndex = 4;
			// 
			// label3
			// 
			this->label3->AutoSize = true;
			this->label3->Location = System::Drawing::Point(13, 171);
			...
			// tbAddress
			// 
			this->tbAddress->Location = System::Drawing::Point(310, 286);
			this->tbAddress->Name = L"tbAddress";
			this->tbAddress->Size = System::Drawing::Size(483, 38);
			...
			this->label4->Size = System::Drawing::Size(118, 32);
			this->label4->TabIndex = 5;
			this->label4->Text = L"Address";
			// 
			// tbPhone
			// 
			this->tbPhone->Location = System::Drawing::Point(309, 227);
			this->tbPhone->Name = L"tbPhone";
			this->tbPhone->Size = System::Drawing::Size(483, 38);
			this->tbPhone->TabIndex = 8;
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(13, 230);
			...
			// tbPassword
			// 
			this->tbPassword->Location = System::Drawing::Point(310, 345);
			this->tbPassword->Name = L"tbPassword";
			this->tbPassword->PasswordChar = '*';
			this->tbPassword->Size = System::Drawing::Size(483, 38);
			this->tbPassword->TabIndex = 10;
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(15, 345);
			...
			// tbConfirmPassword
			// 
			this->tbConfirmPassword->Location = System::Drawing::Point(310, 405);
			this->tbConfirmPassword->Name = L"tbConfirmPassword";
			this->tbConfirmPassword->PasswordChar = '*';
			this->tbConfirmPassword->Size = System::Drawing::Size(483, 38);
			this->tbConfirmPassword->TabIndex = 12;
			// 
			// label7
			// 
			this->label7->AutoSize = true;
			this->label7->Location = System::Drawing::Point(15, 405);
			...
			// btnOK
			// 
			this->btnOK->Location = System::Drawing::Point(310, 464);
			this->btnOK->Name = L"btnOK";
			this->btnOK->Size = System::Drawing::Size(229, 43);
			...
			// btnCancel
			// 
			this->btnCancel->Location = System::Drawing::Point(562, 464);
			this->btnCancel->Name = L"btnCancel";
			this->btnCancel->Size = System::Drawing::Size(229, 43);
			...
			this->llLogin->Location = System::Drawing::Point(706, 529);
			...
			this->ClientSize = System::Drawing::Size(805, 570);
...
#pragma endregion
	...
	private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		try
		{
			String^ connString = "Data Source=localhost\\;Initial Catalog=myrestaurant;Integrated Security=True";
